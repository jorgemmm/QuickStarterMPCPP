...
#include "BaseOnlineCharacter.generated.h"
...
UCLASS()
class QUCIKSTARTER_MP_CPP_API ABaseOnlineCharacter : public ACharacter
{
	GENERATED_BODY()

public:
	// Sets default values for this character's properties
	ABaseOnlineCharacter();
...
public:	
	...
	/** RepNotify for changes When The Charcter Dead.*/
	UFUNCTION()
		void OnRep_bDead();
	...
	UFUNCTION(BlueprintCallable, Category = "Health")
		...
		/* En player controller pues es persistente
	UFUNCTION(BlueprintPure, Category = "Health")
		void GetIsDead();*/
	...
	/** Genera un bug en el editor de playercharacter*/
	//virtual void Destroyed() override;

	
	
	/** Event for Respawn Player Deprecated */
	/*UFUNCTION(BlueprintCallable, Category = "Health")
		void Respawn();*/
